        ...
        this.group = {
            ...
            update: (chatId, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const updateGroupProfileOptions = {
                    ...
                    groupDescription: options.description !== undefined
                        ? options.description
                        : group.groupDescription,
                    groupImage: options.image !== undefined ? options.image : group.groupImage,
    ...
    message(target, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return historyMessages.length > 0
                ? Object.assign(Object.assign({}, historyMessages[0]), { listType }) : null;
        });
    }
    ...
    unblock(users) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const userDIDsPromises = users.map((user) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                return (yield (0, helpers_2.convertToValidDID)(user, this.env)).toLowerCase();
            }));
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (isGroupChat) {
                    ...
                    const participant = participants.find((participant) => participant !== (0, helpers_2.walletToPCAIP10)(accountToUse));
                    if (participant) {
