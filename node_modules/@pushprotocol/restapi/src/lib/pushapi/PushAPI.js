...
class PushAPI {
    constructor(env, account, readMode, alpha, decryptedPgpPvtKey, pgpPublicKey, signer, progressHook, initializationErrors) {
        ...
        this.channel = new channel_1.Channel(this.signer, this.env, this.account, this.decryptedPgpPvtKey);
        this.notification = new notification_1.Notification(this.signer, this.env, this.account, this.decryptedPgpPvtKey);
