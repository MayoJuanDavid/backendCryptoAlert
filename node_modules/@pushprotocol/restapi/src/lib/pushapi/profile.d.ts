...
export declare class Profile {
    ...
    constructor(account: string, env: ENV, cache: LRUCache<string, any>, decryptedPgpPvtKey?: string | undefined, progressHook?: ((progress: ProgressHookType) => void) | undefined);
