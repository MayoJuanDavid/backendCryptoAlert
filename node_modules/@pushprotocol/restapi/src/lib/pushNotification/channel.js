...
class Channel extends pushNotificationBase_1.PushNotificationBaseClass {
    constructor(signer, env, account, pgpPrivateKey) {
        ...
        this.search = (query, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const { page = constants_1.default.PAGINATION.INITIAL_PAGE, limit = constants_1.default.PAGINATION.LIMIT, filter, tag, user_subscribed, oldFormat = true, } = options || {};
        ...
        this.send = (recipients, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                options.advanced.pgpPrivateKey =
                    (_d = options.advanced.pgpPrivateKey) !== null && _d !== void 0 ? _d : this.pgpPrivateKey;
                const lowLevelPayload = this.generateNotificationLowLevelPayload({
                    signer: this.signer,
                    env: this.env,
                    recipients: recipients,
                    options: options,
                    channel: (_e = options.channel) !== null && _e !== void 0 ? _e : this.account,
        ...
        this.notifications = (account, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.list = (options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const { page, limit, sort = PushNotificationTypes_1.ChannelListSortType.SUBSCRIBER, order = PushNotificationTypes_1.ChannelListOrderType.DESCENDING, filter, tag, user_subscribed, } = options || {};
        ...
        this.tags = new tags_1.Tags(this, signer, env, account);
    }
}
