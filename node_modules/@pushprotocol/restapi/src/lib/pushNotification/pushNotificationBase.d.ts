...
export declare class PushNotificationBaseClass {
    ...
    protected generateNotificationLowLevelPayload({ signer, env, recipients, options, channel, channelInfo, }: {
        signer: SignerType;
        env: ENV;
        recipients: string[];
    ...
    protected initiateAddAlias(contract: any, alias: string): Promise<any>;
    protected verifyAlias(contract: any, channelAddress: string): Promise<{
        verifyAliasRes: any;
        channelInfo: any;
    }>;
    /**
