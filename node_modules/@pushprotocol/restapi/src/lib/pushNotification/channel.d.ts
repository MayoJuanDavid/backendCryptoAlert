...
import { ChannelFeedsOptions, ChannelInfoOptions, ChannelListOptions, ChannelOptions, ChannelSearchOptions, CreateChannelOptions, NotificationOptions, NotificationSettings } from './PushNotificationTypes';
...
export declare class Channel extends PushNotificationBaseClass {
     ...
     */
    info: (channel?: string, options?: ChannelOptions) => Promise<any>;
    /**
    ...
    notifications: (account: string, options?: ChannelFeedsOptions) => Promise<any>;
    list: (options?: ChannelListOptions) => Promise<any>;
}
