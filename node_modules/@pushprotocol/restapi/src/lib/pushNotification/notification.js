    ...
    constructor(signer, env, account, pgpPrivateKey) {
            ...
            try {
                ...
                if (options === null || options === void 0 ? void 0 : options.account) {
                    if (this.isValidPCaip(options.account)) {
                        account = (0, helpers_1.pCAIP10ToWallet)(options.account);
                    }
                    else {
                    ...
                    account = (0, helpers_1.getFallbackETHCAIPAddress)(this.env, this.account);
                }
        ...
        this.subscriptions = (options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                page = constants_1.default.PAGINATION.INITIAL_PAGE, limit = constants_1.default.PAGINATION.LIMIT, channel = null, raw, } = options || {};
                let account;
                if (options === null || options === void 0 ? void 0 : options.account) {
                    if (this.isValidPCaip(options.account)) {
                        account = (0, helpers_1.pCAIP10ToWallet)(options.account);
