...
const PushAPI_1 = require("../pushapi/PushAPI");
...
class PushNotificationBaseClass {
    ...
    generateNotificationLowLevelPayload({ signer, env, recipients, options, channel, channelInfo, }) {
        ...
        let index = '';
        const settings = channelInfo && channelInfo.channel_settings
                ...
                if (typeof ele.value == 'number')
                    ...
                    userSetting =
                        userSetting +
                            ...
                            enabled +
                            SETTING_DELIMITER +
                            ((_a = ele.value) === null || _a === void 0 ? void 0 : _a.lower) +
                            SETTING_DELIMITER +
                            ((_b = ele.value) === null || _b === void 0 ? void 0 : _b.upper);
                }
            }
            else {
                // boolean type
    ...
    getChannelOrAliasInfo(address) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const channelOrAliasCaip = (0, helpers_2.validateCAIP)(address)
                    ? address
