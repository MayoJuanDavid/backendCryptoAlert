...
import { ADDITIONAL_META_TYPE, IDENTITY_TYPE, NOTIFICATION_TYPE, SPACE_ACCEPT_REQUEST_TYPE, SPACE_DISCONNECT_TYPE, SPACE_INVITE_ROLES, SPACE_REQUEST_TYPE, VIDEO_NOTIFICATION_ACCESS_TYPE } from '../../lib/payloads/constants';
...
export declare namespace TYPES {
    namespace VIDEO {
        type DATA = VideoCallData;
        type EVENT = VideoEvent;
    }
    namespace SPACE {
        type DATA = SpaceData;
        type EVENT = SpaceMemberEventBase;
    }
}
export declare enum NotifictaionType {
    BROADCAT = 1,
    TARGETTED = 3,
    SUBSET = 4
}
