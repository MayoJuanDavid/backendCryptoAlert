...
const unsubscribeV2 = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { signer, channelAddress, userAddress, verifyingContractAddress, env = constants_1.default.ENV.PROD, onSuccess, onError, pgpPrivateKey, } = options || {};
    try {
        ...
        if (pgpPrivateKey) {
            ...
            // TODO: Add chainid
            const data = (0, signature_helpers_1.getSubscriptionMessageV2)(channelCAIPDetails.address, _userAddress, 'Unsubscribe');
            messageInformation = {
                data: data,
            };
