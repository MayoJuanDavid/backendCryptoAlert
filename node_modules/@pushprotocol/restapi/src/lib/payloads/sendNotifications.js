    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const convertedRecipient = typeof recipient == 'string' && (recipient === null || recipient === void 0 ? void 0 : recipient.split(':').length) == 3
                ? recipient.split(':')[2]
                : recipient;
            return (channelorAlias == convertedRecipient &&
                type == constants_1.NOTIFICATION_TYPE.TARGETTED);
        }
        catch (e) {
            return true;
        }
...
function sendNotification(options) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            */
            senderType = 0, signer, type, identityType, payload, recipients, channel, graph, ipfsHash, env = constants_2.ENV.PROD, chatId, rules, pgpPrivateKey, channelFound = true, } = options || {};
            ...
            const apiPayload = Object.assign({ verificationProof,
                identity, sender: senderType === 1 && !(0, helpers_2.isValidNFTCAIP)(_channelAddress)
