...
import { EnvOptionsType, LiveSpaceData, SignerType, SpaceData, SpaceSpecificData } from '../types';
...
export declare const initLiveSpaceData: LiveSpaceData;
export declare const initSpaceSpecificData: SpaceSpecificData;
export declare const initSpaceData: SpaceData;
...
export declare class Space extends Video {
    protected mergedStream: VideoStreamMerger | null;
    protected spaceSpecificData: SpaceSpecificData;
    protected setSpaceSpecificData: (fn: (data: SpaceSpecificData) => SpaceSpecificData) => void;
    setSpaceData: (fn: (data: SpaceData) => SpaceData) => void;
    ...
    start: typeof start;
    onReceiveMetaMessage: typeof onReceiveMetaMessage;
    onJoinListener: typeof onJoinListener;
    ...
    broadcastRaisedHand: typeof broadcastRaisedHand;
