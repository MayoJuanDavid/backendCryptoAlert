import { IConnectedUser, GroupDTO, SpaceDTO, ChatStatus, Rules, SpaceRules, GroupAccess, SpaceAccess, GroupInfoDTO, SpaceInfoDTO } from '../../types';
...
export declare const groupInfoDtoToSpaceInfoDto: (groupInfoDto: GroupInfoDTO) => SpaceInfoDTO;
export declare const spaceDtoToSpaceInfoDto: (spaceDto: SpaceDTO) => SpaceInfoDTO;
export declare const mapSpaceListTypeToChatListType: (type: SpaceListType) => ChatListType;
